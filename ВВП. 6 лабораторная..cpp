...
int main()
{
	setlocale(LC_ALL, "ru");
	int a, b;
	cout << "Задание №1." << endl << "Введите значение переменных а и b соответственно:" << endl;
	cin >> a >> b;
	a = a + b;
	b = a - b;
	a = a - b;
	cout << a << " " << b << endl;
	cout << "\nЗадание №2." << endl << "Введите значение переменных а, b и с соответственно:" << endl;
	int a1, b1, c1;
	cin >> a1 >> b1 >> c1;
	a1 = a1 + b1 + c1;
	b1 = a1 - b1- c1;
	...
	b1 = b1 - c1;
	cout << a1 << " " << b1 << " " << c1 << endl;
	cout << "\nЗадание №3." << "\nВведите значение переменных а, b и с соответственно:" << endl;
    int a2, b2, c2;
	cin >> a2 >> b2 >> c2;
	a2 = a2 + b2 + c2;
	c2 = a2 - b2 - c2;
